...
def _prepare_nemo_gym_rows(
    ...
    """Apply sampling parameters and Gym task-relative row indices in place."""
    for row_index, row in enumerate(rows):
        ...
        row[NEMO_GYM_ROLLOUT_INDEX_KEY] = row_index % num_generations
            ...
            try:
                ...
                async for future in rollout_gen:
                    ...
                    await event_queue.put(
                        ("row", attempt_id, (rowidx, result, timing_metrics))
                    )
